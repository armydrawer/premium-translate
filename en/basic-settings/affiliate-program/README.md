...
Affiliate rewards are calculated based on either the [profit of the exchange service](https://premium.gitbook.io/main/en/basic-settings/affiliate-program/profit-and-partner-percentage#deductions-from-the-exchangers-profit) or the [amount of the exchange](https://premium.gitbook.io/main/en/basic-settings/affiliate-program/profit-and-partner-percentage#deductions-from-the-exchange-amount). Affiliate rewards are cumulative.
...
## [**Banners**](https://premium.gitbook.io/main/en/basic-settings/affiliate-program/partner-banners)
