...
{% hint style="warning" %}
To discuss the terms of service, please contact a [service representative](https://t.me/FeeCutExManager).
...
**Secret Key** — the API key provided to you earlier by the One Label representative.

**User UUID** — the ID provided to you earlier by the One Label representative.
