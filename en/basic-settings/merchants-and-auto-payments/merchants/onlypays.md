...
<figure><img src="../../../.gitbook/assets/image (2170) (1).png" alt="" width="447"><figcaption></figcaption></figure>
...
{% hint style="success" %}
To automatically update the status of requests without creating a cron job on the server, provide the merchant with a link for the webhook (in the "**Webhook URL**" field) and ask them to set it up for the module to receive. ![](<../../../.gitbook/assets/image (2173) (1).png>)
{% endhint %}
