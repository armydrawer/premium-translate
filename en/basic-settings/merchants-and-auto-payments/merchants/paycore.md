...
After receiving your login credentials from a [service representative](https://t.me/Paycore_pw), log in to the [PayCore Admin Panel](https://paycore.pw/admin) and complete the verification process. Once verified, request an API key from the service representative for integration.
