...
* **Requisites** — returns a card or phone number for transferring funds in the request using the shortcode \[to_account].
...
**Request** — use the currency code from the exchange direction to select requisites (choose **\[You Give] Currency Code**).

**Additional Fields** — use the [additional currency field](https://premium.gitbook.io/main/osnovnye-nastroiki/valyuty-i-napravleniya-obmena/dopolnitelnye-polya#dopolnitelnye-polya-dlya-valyuty) "**I Give**" to select requisites.
