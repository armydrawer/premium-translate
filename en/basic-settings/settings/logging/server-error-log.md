...
<figure><img src="../../../../ru/.gitbook/assets/image (781) (1).png" alt=""><figcaption></figcaption></figure>

<figure><img src="../../../../ru/.gitbook/assets/image (782) (1).png" alt=""><figcaption></figcaption></figure>

## Option 2

In the ISP Manager panel, navigate to the specified folder:

<figure><img src="../../../../ru/.gitbook/assets/image (802) (1).png" alt=""><figcaption></figcaption></figure>

Look for the file **`your_domain.error.log`** in the list and open it.

<figure><img src="../../../../ru/.gitbook/assets/image (783) (1).png" alt="" width="397"><figcaption></figcaption></figure>
...
<figure><img src="../../../../ru/.gitbook/assets/image (799) (1).png" alt=""><figcaption></figcaption></figure>

It is also recommended to enable error reporting in the `wp-config.php` file located in the root folder of your site:

<figure><img src="../../../../ru/.gitbook/assets/image (800) (1).png" alt=""><figcaption></figcaption></figure>

Open the file, [replace **false** with **true**](#user-content-fn-1)[^1] in the specified location, and save your changes.

<figure><img src="../../../../ru/.gitbook/assets/image (801) (1).png" alt=""><figcaption></figcaption></figure>
