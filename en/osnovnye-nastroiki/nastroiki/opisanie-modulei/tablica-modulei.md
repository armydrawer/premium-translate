...
| Module Name                                   | Technical Module Name | Current Version | Module Description                                                                 | Dependent Modules |
|-----------------------------------------------|-----------------------|-----------------|------------------------------------------------------------------------------------|-------------------|
| Automatic User Registration                    | autoreg               | 2.7.0          | Automatic user registration during exchanges                                       |                   |
| Automatic Profit Calculation                   | profit                | 2.7.0          | Automatic profit calculation                                                         |                   |
| Auto-Deletion of Unpaid Requests               | autodel_bids          | 2.7.0          | Auto-deletion of unpaid requests with the option to set a custom deletion time     |                   |
| Archiving Old Requests                         | archive_bids          | 2.7.0          | !Do not disable this module after activation! Archiving old requests older than two months |                   |
...
| Second Currency Logo                           | twologo               | 2.7.0          | Second logo for currency                                                             | -                 |
...
| Banned Email Domains                           | dismaildir            | 2.7.0          | Banned email domains                                                                |                   |
...
| Coupon Code for Auto-Payment                  | fix_btc_codes         | 2.7.0          | !Do not activate unless necessary! Display of the auto-payment coupon code in the application card |                   |
...
| Exchange Direction Rate Limits                  | direction_climits     | 2.7.0          | Limits on exchange direction rates                                                  |                   |
| Auto-Payment Log                               | paymerchantlogs       | 2.7.0          | !Do not activate unless necessary! Auto-payment log                                 |                   |
| Merchant Log                                   | merchantlogs          | 2.7.0          | !Do not activate unless necessary! Logging of merchant requests sent by payment systems after payment. |                   |
...
| Admin Action Logging                           | apbd_logs             | 2.7.0          | Logging of admin actions                                                             |                   |
| Max Decimal Places in Database                 | numsymb               | 2.7.0          | Maximum number of decimal places in the database                                    | -                 |
| Maximum Display Value of Currency Reserve      | currmaxreserv         | 2.7.0          | Maximum display value of currency reserve                                            |                   |
...
| XML/TXT File Output Settings for Exchange Directions | direction_xml      | 2.7.0          | Settings for outputting exchange directions in XML/TXT files                       |                   |
...
| Prevent Negative Currency Reserve               | currminreserv         | 2.7.0          | Prevent negative currency reserve                                                    |                   |
...
| Real-Time Application Status Update            | livestatus            | 2.7.0          | Real-time update of application status in the control panel                        |                   |
| Personal Data Processing                       | checkpersdata         | 2.7.0          | Checkbox for "Consent to process personal data" in forms                           |                   |
...
| Exchange Rate Parser from File                | files_course          | 2.7.0          | Parser for exchange rates from a file                                              |                   |
| Rate Parser 2.0                               | parser_settings        | 2.7.0          | Rate parser 2.0                                                                     |                   |
| Reserve Parser from File                       | files_reserv          | 2.7.0          | Parser for reserves from a file                                                     | naps_reserv       |
...
| Email Registration Confirmation                | rconfirm              | 2.7.0          | Email confirmation for registration                                                  |                   |
| Custom Application Statuses                    | bids_status           | 2.7.0          | Custom application statuses                                                          |                   |
| Exchange Rate Conversion                       | lead                  | 2.7.0          | Conversion of exchange rates to the format 1 to XXX                                | -                 |
...
| Merchant Proxy                                 | proxy                 | 2.7.0          | Proxy for merchants                                                                  | -                 |
...
| Exchange Request Editor                        | editbids             | 2.7.0          | Editor for exchange requests                                                         |                   |
...
| Auto-Payment Error Status                      | payouterror           | 2.7.0          | Status "Auto-Payment Error"                                                         |                   |
...
| Currency Tag                                   | currtags              | 2.7.0          | Tag for currency                                                                    |                   |
| Maintenance Notification Text                  | updatetext            | 2.7.0          | Maintenance notification text                                                        | -                 |
| Hyphen in Exchange Direction URL               | direction_url         | 2.7.0          | Replacing underscores with hyphens in the exchange direction URL                   |                   |
| Trading Actions                                | tradeapi              | 2.7.0          | Trading actions                                                                     |                   |
| Notification in Header                         | notice_header         | 2.7.0          | Notification block on a red background in the site header                          | -                 |
...
| Deletion of Request Files                      | removefiles           | 2.7.0          | Deletion of request files upon complete deletion or archiving                       |                   |
| Set Initial Request ID                         | setbidid              | 2.7.0          | Set the initial request ID                                                           |                   |
