...
<figure><img src="../../.gitbook/assets/image (2110).png" alt="" width="515"><figcaption></figcaption></figure>
...
*   **Пользователи и файлы cookie** — привязка к рефереру[^1] (партнёру) будет действовать, когда реферер прикреплен в настройках реферала (привлеченный пользователь) (указывайте ID пользователя обменника), \
    ...
    <figure><img src="../../.gitbook/assets/image (2111).png" alt="" width="329"><figcaption></figcaption></figure>
...
*   **Да, процент скидки** — будет учитываться персональный процент скидки реферала\
    ...
    <figure><img src="../../.gitbook/assets/image (2113).png" alt="" width="312"><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (2114).png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (2116).png" alt="" width="563"><figcaption></figcaption></figure>
