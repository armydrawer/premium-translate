...
**Additional Field Name** — the name of the field as it appears on the exchange form on the website.
...
**Hint for "From Account"/"To Account" Field** — a hint that will be displayed to the user when filling out the field.

**Add for Currency I Give** — displays the additional field for the currency when it is on the "I Give" side of the exchange direction.

**Add for Currency I Receive** — displays the additional field for the currency when it is on the "I Receive" side of the exchange direction.
...
**Input Hint** — a hint that will be displayed to the user when filling out the field.

**Add Field to Exchange Directions** — displays the additional field for the selected exchange directions in the request form.