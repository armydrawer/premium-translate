...
If the response shows currency rates, then the source is accessible from your server. ![](<../../../.gitbook/assets/image (671).png>)
{% endhint %}
...
<figure><img src="../../../.gitbook/assets/image (1971).png" alt=""><figcaption><p>Section in the sidebar</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (1974).png" alt=""><figcaption><p>The formula will be inserted directly into the exchange rate without parentheses, and then the exchange rate value will be calculated.</p></figcaption></figure>

• Index Value

<figure><img src="../../../.gitbook/assets/image (1973).png" alt=""><figcaption><p>First, the coefficient value will be calculated, and then it will be used in the exchange rate.</p></figcaption></figure>
