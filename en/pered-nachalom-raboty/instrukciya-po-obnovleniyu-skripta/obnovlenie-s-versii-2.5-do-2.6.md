...
<figure><img src="../../.gitbook/assets/image (1775).png" alt="" width="563"><figcaption><p><strong>Delete all checked files and folders from your server</strong></p></figcaption></figure>
...
4. After the update, in the "**Exchange Settings**" -> "**General Settings**" section, <mark style="color:red;">**make sure to**</mark> select the logic for handling requests when using receiving merchants for the option "**Action if the merchant fails**."\
   For more details on how this option works, refer to the "[**General Merchant Settings**](https://premium.gitbook.io/main/osnovnye-nastroiki/merchanty-i-avtovyplaty/merchanty/obshie-nastroiki-merchantov#podklyuchenie-neskolkikh-merchantov)" guide.