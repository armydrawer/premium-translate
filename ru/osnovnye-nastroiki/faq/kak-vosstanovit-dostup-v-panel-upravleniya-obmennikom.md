...
1.  Временно переименуйте файл **`/wp-content/themes/exchanger/functions.php`** на сервере. Временное имя файла может быть любым.<br>
...
3.  В панели управления в разделе "**Плагины**" активируйте плагин "**Premium Exchanger**".<br>
