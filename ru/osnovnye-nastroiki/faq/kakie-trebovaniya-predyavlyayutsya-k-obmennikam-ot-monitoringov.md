...
<summary>Необходимо отключить кэширование отдаваемых файлов для IP-адресов нашего робота</summary>

Для добавления пула IP-адресов от мониторинга воспользуйтесь [инструкцией](https://premium.gitbook.io/main/osnovnye-nastroiki/faq/dobavlenie-ip-adresov-v-whitelist-v-cloudflare) или добавьте сам домен мониторинга в исключения.
...
<summary>Ответ о прохождении предварительной AML-проверки</summary>

Пользователь сайта должен подтвердить, что он готов к тому, что его обмен может быть приостановлен в рамках [AML-проверки](https://www.bestchange.ru/report/) (что означает возврат средств обратно за вычетом комиссии сети).

Для соответствия этому требованию в админ-панели создайте новое дополнительное поле для направления обмена (не для валюты!),\
...
![](<../../.gitbook/assets/изображение (59) (1).png>)
