...
{% hint style="warning" %}
Обращаем ваше внимание, что такой модуль автовыплаты технический и **не производит** саму выплату — [модуль на приём Crypto-Cash](https://premium.gitbook.io/main/osnovnye-nastroiki/merchanty-i-avtovyplaty/merchanty/crypto-cash) производит выплату криптовалюты сразу же после поступления средств от клиента, а модуль автовыплаты только подтверждает выплату средств для изменения статуса заявки на "**Выполненная**".

Использовать модуль автовыплаты Crypto-Cash **всегда необходимо** в паре с [модулем на приём средств](https://premium.gitbook.io/main/osnovnye-nastroiki/merchanty-i-avtovyplaty/merchanty/crypto-cash).
