...
<figure><img src="../../../.gitbook/assets/изображение.png" alt="" width="378"><figcaption></figcaption></figure>

Заполните указанные авторизационные поля.

<figure><img src="../../../.gitbook/assets/изображение (2).png" alt="" width="409"><figcaption></figcaption></figure>
...
Для удобства работы пара ключей автоматичсеки генерируется для работы с мерчантом (для корректной работы генератора на сервере должна быть запущена служба/расширение **Sodium**). Скопируйте эти ключи из настроек модуля автовыплаты и вставьте их в соответствующие поля согласно интсрукции выше.
