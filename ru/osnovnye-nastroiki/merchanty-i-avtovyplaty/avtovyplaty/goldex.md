...
{% hint style="warning" %}
Для обсуждения условий и подключения свяжитесь с [представителем сервиса](https://t.me/premiumexchanger).
...
Также обратите внимание, что **обязательно** нужно создавать отдельную копию модуля GoldEx на каждый используемый диапазон сумм из вышеуказанного выпадающего списка и устанавливать соответствующий диапазон сумм в каждой версии модуля,\
