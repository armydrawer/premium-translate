...
{% hint style="warning" %}
Для обсуждения условий и подключения, свяжитесь с [представителем сервиса](https://t.me/Unite_Plat).
...
**Username** — юзернейм на латинице, придуманный вами и переданный представителю Unite для указания его в вашем ЛК
