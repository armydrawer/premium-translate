...
Часто это тип суммы "**Сумма для резерва**" в настройках модуля мерчанта — проверьте его в первую очередь. Выберите подходящий пункт, сохраните настрйоки и оплатите заявку. Если заявка после оплаты на полную сумму перейдет в статус "**Оплаченная**", то настройки установлены корректно.
