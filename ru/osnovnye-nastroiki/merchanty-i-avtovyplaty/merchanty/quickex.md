...
{% hint style="danger" %}
Обратите внимание, что для работы с мерчантом Quickex вам обязательно нужно сообщить представителю сервиса IP-адрес вашего сервера для добавления его в whitelist на стороне самого Quickex.
{% endhint %}
