...
**Key ID** — ID, скопированный ранее в ЛК Unite

**Приватный ключ** — ключ, скопированный ранее в ЛК Unite
...
* **TPay** — реквизиты для оплаты через [T-Pay](https://www.tbank.ru/t-pay/online/)
