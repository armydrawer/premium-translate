...
1.  Из-под пользователя, созданного для сайта (**не root**) загрузите и распакуйте модуль **tradeapi** в папку `wp-content/plugins/premiumbox` на сервере.<br>

    <figure><img src="../../../.gitbook/assets/изображение (168).png" alt=""><figcaption></figcaption></figure>
2.  В разделе "**Модули**" активируйте модуль "**Торговые действия**".<br>
