...
<figure><img src="../../.gitbook/assets/image (2251) (1).png" alt="" width="518"><figcaption></figcaption></figure>

**Скрыть направления обменов от гостей** — направления обмена на сайте будут отображаться только для зарегистрированных пользователей

**Проверка на новичка** — параметры, по которым производится проверка на новичка (пользователя без успешных обменов на сайте). Вы можете выбрать как один, так и несколько параметров — при обнаружении "новичка" по любому из параметров, в заявке в разделе "Заявке" вы увидите уведомление об этом.

<figure><img src="../../.gitbook/assets/image (2250).png" alt=""><figcaption></figcaption></figure>

**Метод определения новичка:**

* **если все реквизиты пользователя уникальные** — уведомление о новичке отобразится только если все параметры будут уникальными
* **если хотя бы один из реквизитов пользователя уникальный** — уведомление о новичке отобразится если любой из параметров будет уникальным

**Предупреждающий текст перед созданием заявки для новичка** — текст, которые будет отображаться для новичка перед созданием заявки

**Текст ошибки, если сумма превышает заданный лимит для новичка** — текст, который будет отображаться новичку при превышении допустимого для него лимита
...
* **По крону** — настройте[ задание cron](https://premium.gitbook.io/main/osnovnye-nastroiki/faq/kak-sozdat-zadanie-cron-na-servere) для запуска пересчета по расписанию. Ссылка для задания cron находится в разделе "**Настройки**" ➔ "**Cron**"

![](https://premium.gitbook.io/main/~gitbook/image?url=https%3A%2F%2F2574066779-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252Fm9kqZXsNykrN6VyxxXBO%252Fuploads%252FDvX2WiJ3wSNW0upqAoMH%252Fimage.png%3Falt%3Dmedia%26token%3D372bbe20-0520-42ad-b2cf-daf22f6a005f\&width=300\&dpr=4\&quality=100\&sign=18f76a5a\&sv=2)

* **Всегда** — пересчет будет производиться и при запуске задания cron, и при изменении статуса заявки

**Если курс недоступен (пересчет заявки по курсу):**

* **Пересчитать заявку по нулевому курсу** — при потере курса обмена заявка будет пересчитана через 0 во избежание потерь дежных средств обменником (сумма в заявке для клиента будет отображаться как 0 до момента восстановления курса обмена для направления обмена)
* **Пересчитать заявку по старому курсу** — при потере курса обмена заявка будет пересчитана по последнему полученному от парсера курсу для направления обмена
