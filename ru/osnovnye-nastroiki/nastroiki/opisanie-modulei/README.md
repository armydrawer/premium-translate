...
Модуль позволяет добавить дополнительное правило в разделе "**Настройки обменника**" ➔ "**Основные настройки**" в форму обмена для всех направлений обмена

<figure><img src="../../../.gitbook/assets/изображение (233).png" alt=""><figcaption><p>Настройка правила в админ-панели</p></figcaption></figure>

<figure><img src="../../../.gitbook/assets/изображение (234).png" alt=""><figcaption><p>Отображение в форме обмена на сайте</p></figcaption></figure>
...
Настройки модуля находятся в разделе "**Заявки" → "Текущий ID заявки"**.
...
![](<../../../.gitbook/assets/image (169).png>)<br>
