...
Для того, чтобы пользователь мог оставить заявку на выплату в настройках выплачиваемой валюты должна быть включен "Вывод партнёрских средств" и **резерв в валюте** должен быть больше максимальной суммы выплаты.
...
<img src="../../.gitbook/assets/image (2060).png" alt="" data-size="original">
...
<img src="../../.gitbook/assets/image (2059).png" alt="" data-size="original">
...
*   **Пользователи и файлы cookie** — привязка к рефереру (партнёру) будет действовать, когда реферер прикреплен в настройках реферала (привлеченный пользователь) (указывайте ID пользователя обменника),<br>
