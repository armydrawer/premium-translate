...
![](<../../.gitbook/assets/image (2257).png>)![](<../../.gitbook/assets/image (2260).png>)
{% endhint %}

{% hint style="success" %}
Начниая с версии 2.6 также можно отправлять сообщения только тем контактам, что указаны в настройках направления обмена, вкладка "**Настройки уведомлений**".
