...
* Пользователь должен активировать вашего бота для уведомлений командой `/start` и получить от него ответ\
  ![](<../../.gitbook/assets/изображение (213).png>)
{% endhint %}
...
<figure><img src="../../.gitbook/assets/image (1235) (1).png" alt=""><figcaption><p>Раздел "<strong>Пользователи</strong>" -> "<strong>Редактировать</strong>"</p></figcaption></figure>
...
<img src="../../.gitbook/assets/image (2257).png" alt="" data-size="original"><img src="../../.gitbook/assets/image (2258) (1).png" alt="" data-size="original">
{% endhint %}
...
<img src="../../.gitbook/assets/image (2256).png" alt="" data-size="original">
{% endhint %}
